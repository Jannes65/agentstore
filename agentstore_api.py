...
@app.get("/admin/credit-agent")
def credit_agent(db: Session = Depends(get_db)):
    # AI Detector agent wallet id: e8265f98-9a9b-42b6-bb7e-e702dfde4b81
    db.execute(text("""
    ...
    return {"status": "credited", "agent_id": result[0], "new_balance": result[1]}
